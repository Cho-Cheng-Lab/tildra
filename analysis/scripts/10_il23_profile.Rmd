...
IL17 responsive (genes that go up after IL17 treatment and )
...
il23_responsive <- de_pre_vs_post_response %>% 
...
```{r}
il17_genes <- il17_responsive$gene

```

```{r}
il23_responsive$gene %>% intersect(il17_responsive$gene)
```
