...
seuratobj <- seuratobj %>% 
    ...
    FindClusters(resolution = seq(0.1, 2, by = 0.1))
```
...
```
```{r}
p <- seurat_feature(seuratobj, features = c('RNA_snn_res.1'), facet_hide = TRUE, color_package = 'generate', color_palette = 'custom1', legend_position = 'none', title = 'Resolution: 1.0')
