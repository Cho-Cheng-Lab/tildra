...
```{r}
de_pre_vs_mid_response <- read_tsv(here('analysis/output/08_de', which_cluster, 'de_pre_vs_mid_responder.tsv.gz'))

de_compare_trm <- inner_join(de_pre_vs_mid_response %>% 
                               filter(cluster == 'Trm1') %>% 
