...
### Pre vs post in responders vs non-responders
```{r}
condition1 <- 'PV'
condition2 <- 'PV'
treatment1 <- 'Pre'
...
### Responders vs non responders in Pre and post samples
```{r}
condition1 <- 'PV'
condition2 <- 'PV'
treatment1 <- 'Pre'
...
de_responders_vs_nonresponders <- map(c('Pre', 'Post'), function(i) {
...
de_pre_vs_post_response_apc <- map(c('responders', 'non-responders'), function(i) {
...
de_pre_vs_post_response_apc %>% write_tsv(file.path(output_dir, 'de_pre_vs_post_response_apc.tsv.gz'))
write_excel_notebook(input_table = de_pre_vs_post_response_apc,
                     output_file = file.path(output_dir, 'de_pre_vs_post_response_apc.xlsx'),
                     tabs = 'response',
                     prefix = '')
```
