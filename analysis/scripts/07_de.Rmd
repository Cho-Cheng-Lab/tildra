...
de_responders_vs_nonresponders_pre %>% write_tsv(file.path(output_dir, 'de_responders_vs_nonresponders_pre.tsv.gz'))
...
de_responders_vs_nonresponders_mid <- map(which_clusters$merged_label, function(i) {
  ...
  de_pipeline_barcodes(seuratobj = seuratobj,
                       ...
                       barcodes1 = responder_barcodes,
                       barcodes2 = nonresponder_barcodes,
                       group1_id = paste0('Responders_Mid'),
                       group2_id = paste0('Non-responders_Mid'))
  
}) %>% 
  bind_rows() %>% 
  as_tibble()

de_responders_vs_nonresponders_mid %>% write_tsv(file.path(output_dir, 'de_responders_vs_nonresponders_mid.tsv.gz'))

write_excel_notebook(input_table = de_responders_vs_nonresponders_mid,
                     output_file = file.path(output_dir, 'de_responders_vs_nonresponders_mid.xlsx'))
```
...
list(de_ad_vs_hc,
     ...
     de_ad_vs_pv,
     de_pre_vs_mid,
     de_responders_vs_nonresponders_pre,
     de_responders_vs_nonresponders_mid) %>% 
  bind_rows() %>% 
