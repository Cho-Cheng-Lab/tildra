...
```{r}
load('data/external/20180706_Novartis062518_FilteringAndQC/RObj-CountAndAnnoTables_Novartis062518_20190624.rdata')
```
...
metadata <- anno.n062518 %>% rownames_to_column('sample') %>% 
  mutate(Response = case_when(
    ...
    str_detect(PatientOutcome.Week52,'PASI50|limited') ~ 'Nonresponder',
  ))
