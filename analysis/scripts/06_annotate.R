...
## -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
p <- seuratobj %>% seurat_feature(features = 'cluster', facet_hide = TRUE, legend_position = 'none', size = 0.1, alpha = 0.1, color_package = 'carto', color_palette = 'Bold', rasterize_dpi = 600)
...
## -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
p <- seuratobj %>% seurat_feature(features = 'supercluster', facet_hide = TRUE, legend_position = 'none', size = 0.1, alpha = 0.1, color_package = 'carto', color_palette = 'Bold', rasterize_dpi = 600)
