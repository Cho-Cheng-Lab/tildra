...
de_combined_cluster <- read_tsv(here('analysis/output', which_de, which_cluster, 'de_combined.tsv.gz'))
de_combined_supercluster <- read_tsv(here('analysis/output', which_de, which_supercluster, 'de_combined.tsv.gz'))
de_combined_ultracluster <- read_tsv(here('analysis/output', which_de, which_ultracluster, 'de_combined.tsv.gz'))
```
```{r}
...
de_ultracluster_tally
```
```{r}
de_cluster_tally <- de_combined_cluster %>% 
  filter(comparison %in% c('PV vs HC',
                           'Pre vs Mid',
                           'Responder Pre vs Responder Mid',
                           'Non-responder Pre vs Non-responder Mid')) %>% 
